...
ArticleTemplate.store.add({
  ...
  attributes: {
    ...
    content: [
      ...
      taciti, id nulla proin a, sociis est felis massa. Eleifend lectus, nec amet vestibulum pede. Risus justo praesent
      ...
      proin augue vestibulum luctus vitae laoreet nec.</p><p>Ultricies vel magna nullam, rutrum odio, vel leo mus arcu.
